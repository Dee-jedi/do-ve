    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
      <div className="relative w-full max-w-lg max-h-[90vh] flex flex-col rounded-2xl border border-gold-500/40 bg-[#100d0b] text-gold-100 shadow-[0_20px_50px_rgba(0,0,0,0.9)] overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-6">
          {/* Submission Form */}
          <form onSubmit={handleSubmit} className="space-y-4 rounded-xl border border-gold-500/25 bg-[#171311]/80 p-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-espresso-700 bg-[#0c0a09] px-3 py-2 text-sm text-white placeholder-stone-600 focus:border-gold-400 focus:outline-none transition"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-lg border border-espresso-700 bg-[#0c0a09] px-3 py-2 text-sm text-white focus:border-gold-400 focus:outline-none transition"
                >
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full rounded-lg border border-espresso-700 bg-[#0c0a09] px-3 py-2 text-sm text-white placeholder-stone-600 focus:border-gold-400 focus:outline-none transition resize-none"
              />
            </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              {wishes.map((w) => (
                <div
                  key={w.id}
                  className="rounded-xl border border-espresso-700/80 bg-[#14100e] p-3.5 transition hover:border-gold-500/40"
                >
